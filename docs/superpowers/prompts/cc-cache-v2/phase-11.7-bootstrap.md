# Bootstrap Prompt: Execute cc-cache v2 Phase 11.7
...
You are implementing Phase PHASE_NUMBER only for cc-cache v2 in /Users/richardchen/Dev/cc-cache.
...
6. PRD.md and docs/superpowers/specs/2026-06-02-cc-cache-v2-design.md only for requirements directly touched by Phase PHASE_NUMBER.
