...
```text
You are a read-only reviewer for cc-watch v2 Phase PHASE_NUMBER.
...
6. PRD.md and docs/superpowers/specs/2026-06-02-cc-watch-v2-design.md only for requirements touched by Phase PHASE_NUMBER.
