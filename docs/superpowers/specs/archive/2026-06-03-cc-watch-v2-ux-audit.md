# cc-watch v2 — UX/UI Audit, Second Revision

> Historical audit note: this file records an earlier design-review snapshot and is not current implementation guidance. For current behavior, use `PRD.md`, `docs/superpowers/specs/2026-06-02-cc-watch-v2-design.md`, and `docs/superpowers/specs/2026-06-29-cc-watch-v2-visual-grammar.md`.
...
```
╭─────────────────────────────────────────────────────────────────────╮
│  cc-watch / workspace-api / d4b247b7              14:32:18  live    │
╰─────────────────────────────────────────────────────────────────────╯
...
```
╭─────────────────────────────────────────────────────────────────────╮
│  cc-watch  ·  5 sessions  ·  14:32:18  ·  live                     │
╰─────────────────────────────────────────────────────────────────────╯
...
`cc-watch config` — separate command, flat form, no sub-navigation.
