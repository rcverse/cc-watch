# cc-cache v2 Phase 11.9 Architecture Deepening Refactor Implementation Plan
...
**Goal:** Deepen the architecture around cc-cache's current product reality: macOS local TUI, automatic live refresh, stable JSON API, Reminder alarms, bounded KeepAlive, and simple local install.
...
Source of truth: `docs/superpowers/specs/2026-06-18-cc-cache-v2-product-reality.md`.
...
- `internal/app/cli_test.go` - assert live refresh startup wiring and no public `--watch`.
...
- `docs/superpowers/progress/cc-cache-v2-progress.md` - update phase status and verification ledger.
...
```bash
cat AGENTS.md
cat docs/superpowers/runbooks/2026-06-03-cc-cache-v2-implementation-runbook.md
cat docs/superpowers/progress/cc-cache-v2-progress.md
cat docs/superpowers/plans/cc-cache-v2/PLAN.md
cat docs/superpowers/specs/2026-06-18-cc-cache-v2-product-reality.md
cat docs/superpowers/plans/cc-cache-v2/phase-11.9-architecture-simplification.md
```

Expected: no instruction says to replace `$HOME/.local/bin/cc-cache`, publish releases, delete live refresh, or run a real Claude send.
...
```bash
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/refresh -run TestWatcherNextReturnsDomainResultWithoutTeaDependency
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/refresh -run TestWatcherNextClosedChannelsReturnClosedResult
```
...
```bash
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/tui -run TestWatcherEventsDebounceBeforeRefreshSnapshot
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/tui -run 'TestWatcherEventsDebounceBeforeRefreshSnapshot|TestRefresh'
```
...
```bash
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/app -run TestTUIOptionsStartLiveRefreshForListAndWorkspaceOnly
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/tui -run 'TestWatcherEventsDebounceBeforeRefreshSnapshot|Test.*Init'
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/app -run 'TestTUIOptionsStartLiveRefreshForListAndWorkspaceOnly|TestRunTUIClosesLiveRefresh|Test.*Watch'
```

Expected: pass. `--watch` remains rejected or absent as a public CLI mode.
...
```bash
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/tui -run TestWorkspaceKeepAliveRunnerUsesRuntimePolicy
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/keepalive ./internal/tui -run 'TestWorkspaceKeepAliveRunnerUsesRuntimePolicy|TestRunner|TestConfirmation'
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test -race ./internal/keepalive ./internal/tui -run 'TestWorkspaceKeepAliveRunnerUsesRuntimePolicy|TestRunner'
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/keepalive -run TestConfirmation
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/tui -run 'TestWorkspaceKeepAliveActionsProduceRunnerAndConfirmationCommands|TestWorkspaceIgnoresStaleKeepAliveAsyncMessages'
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/jsonout
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/notify ./internal/tui ./internal/jsonout
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/tui -run 'Test.*Focus|Test.*Shortcut|Test.*Config'
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/tui -run 'TestWorkspace.*KeepAlive|Test.*KeepAliveCard'
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/tui -run 'Test.*Refresh|Test.*Watcher|Test.*Degraded'
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/tui -run 'Test.*KeepAlive|Test.*Claude|Test.*Countdown|Test.*Runner|Test.*Confirmation'
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/tui -run 'Test.*Config'
```
...
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/tui
```
...
- Modify: `docs/superpowers/plans/cc-cache-v2/phase-11.9-architecture-simplification.md`
...
```bash
GOCACHE=/private/tmp/cc-cache-go-build GOMODCACHE=/private/tmp/cc-cache-go-mod go test ./internal/refresh ./internal/app ./internal/tui ./internal/keepalive ./internal/notify ./internal/jsonout ./internal/snapshot
```
...
- Scope control: Linux, Windows, Homebrew, GitHub Release, goreleaser, public `--watch`, native macOS app, daemon behavior, and real Claude sends remain out of scope.
