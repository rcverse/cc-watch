# cc-cache v2 Phase 2: Parser Parity
...
- [x] **Step 2.1: Create parser fixtures**
  ...
  - Create: `internal/session/testdata/smoke-home/.claude/projects/-tmp-cc-cache/11111111-1111-1111-1111-111111111111.jsonl`.
  - Create: `internal/session/testdata/smoke-home/.config/cc-cache/config.json`.
