# cc-cache v2 Phase 10: Config Editor
...
- [ ] **Step 10.1: Write failing Config Editor tests**
...
- [ ] **Step 10.2: Implement Config Editor**
...
- [ ] **Step 10.3: Manual config smoke**
  - Run: `go run ./cmd/cc-cache config`.
