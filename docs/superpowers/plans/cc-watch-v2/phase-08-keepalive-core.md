# cc-watch v2 Phase 8: Keepalive Core
...
- [x] **Step 8.1: Write failing KeepAlive timing tests**
...
- [x] **Step 8.2: Implement timing helpers**
  - Create: `internal/keepalive/timing.go`.
  - Run: `go test ./internal/keepalive`.
  - Expected: timing tests pass.

- [x] **Step 8.3: Write failing state-machine tests**
...
- [x] **Step 8.4: Implement KeepAlive model and state machine**
...
- [x] **Step 8.5: Write failing subprocess and confirmation tests**
  - Extend: `internal/keepalive/keepalive_test.go`.
...
- [x] **Step 8.6: Implement runner and confirmation**
