# cc-watch v2 Phase 11.7: TUI Interaction Architecture Refactor Implementation Plan
...
```text
Claude Code Watch / 785b4c0d                         live · updated 13:08:24
...
```text
Claude Code Watch · 5 sessions · watcher ok · live 13:08
...
- [x] **Step 11.7.1: Add focus-registry tests before refactor**
  ...
  - Run: `GOCACHE=/private/tmp/cc-watch-go-build GOMODCACHE=/private/tmp/cc-watch-go-mod go test ./internal/tui -run 'TestFocus|TestVisibleFocus|TestListCursor|TestWorkspaceFocus'`.
...
- [x] **Step 11.7.9: Verification, smoke, reviewer, and ledger update**
  ...
  - Run: `git diff --check`.
  - Build: `GOCACHE=/private/tmp/cc-watch-go-build GOMODCACHE=/private/tmp/cc-watch-go-mod go build -o /private/tmp/cc-watch-phase117-bin/cc-watch ./cmd/cc-watch`.
  - PTY smoke:
  ...
  - Integrate valid review findings, rerun focused and full verification, then update:
    - `docs/superpowers/plans/cc-watch-v2/phase-11.7-tui-interaction-architecture.md`
    - `docs/superpowers/progress/cc-watch-v2-progress.md`
...
- [x] **Phase 11.7 screenshot/review stabilization**
  ...
  - Verification rerun:
    - `GOCACHE=/private/tmp/cc-watch-go-build go test ./internal/tui`
    - `GOCACHE=/private/tmp/cc-watch-go-build go test ./internal/app ./internal/notify`
    - `GOCACHE=/private/tmp/cc-watch-go-build go test -count=1 ./...`
    - `git diff --check`
    - `GOCACHE=/private/tmp/cc-watch-go-build GOMODCACHE=/private/tmp/cc-watch-go-mod go build -o /private/tmp/cc-watch-phase117-refactor/cc-watch ./cmd/cc-watch`
