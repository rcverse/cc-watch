# cc-watch v2 Implementation Runbook

**Purpose:** Strategy and operating model for implementing cc-watch v2 across fresh context windows.

This runbook is not a task checklist and does not contain copy-paste prompts. Use:

- Meta plan: `docs/superpowers/plans/cc-watch-v2/PLAN.md`
- Phase plans: `docs/superpowers/plans/cc-watch-v2/phase-XX-*.md`
- Progress ledger: `docs/superpowers/progress/cc-watch-v2-progress.md`
- Prompt bank: `docs/superpowers/prompts/cc-watch-v2/`
...
5. Current phase file under `docs/superpowers/plans/cc-watch-v2/`
6. `PRD.md`
7. `docs/superpowers/specs/2026-06-02-cc-watch-v2-design.md`
...
- Do not move, remove, or overwrite root `cc_watch.py` until the phase plan's migration gates allow it.
- Do not replace `$HOME/.local/bin/cc-watch` until v2 binary verification passes and the user explicitly approves switchover.
- Do not publish a GitHub Release or Homebrew tap update during normal implementation.
- Do not add a public watch command or flag.
...
- Initial bootstrap: `docs/superpowers/prompts/cc-watch-v2/initial-bootstrap.md`
- Per-phase initialization: `docs/superpowers/prompts/cc-watch-v2/per-phase-initialization.md`
- Resume anywhere: `docs/superpowers/prompts/cc-watch-v2/resume-anywhere.md`
- Phase reviewer: `docs/superpowers/prompts/cc-watch-v2/phase-reviewer.md`
...
9. Update `docs/superpowers/progress/cc-watch-v2-progress.md`.
